...
public class ThongTinMatHang extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ThongTinMatHang frame = new ThongTinMatHang("a", "10", "5");
	 ...
	 * Create the frame.
	 */
	public ThongTinMatHang(String ten_san_pham, String gia_san_pham, String so_luong) {
...
//		label_thanh_tien = new JLabel();
//		int total_buy = Integer.parseInt(tf_so_luong_muon_mua.getText());
//		int price = Integer.parseInt(gia_san_pham);
//		label_thanh_tien.setText(Integer.toString(total_buy * price));
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.TRAILING).addGroup(Alignment.LEADING,
				gl_panel.createSequentialGroup().addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel.createSequentialGroup().addContainerGap().addComponent(lb_title_thanh_tien))
						.addGroup(Alignment.LEADING,
								gl_panel.createSequentialGroup().addGap(33)
										.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
												.addComponent(lb_title_gia, GroupLayout.PREFERRED_SIZE, 22,
														GroupLayout.PREFERRED_SIZE)
												.addComponent(lb_title_tensp).addComponent(lb_title_so_luong_muon_mua,
						...
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(Alignment.TRAILING,
										gl_panel.createParallelGroup(Alignment.LEADING)
												.addComponent(lb_ten_sp, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
														216, Short.MAX_VALUE)
												.addGroup(gl_panel.createSequentialGroup()
														.addComponent(tf_so_luong_muon_mua, GroupLayout.PREFERRED_SIZE,
																44, GroupLayout.PREFERRED_SIZE)
														.addGap(58).addComponent(lb_ton_kho, GroupLayout.PREFERRED_SIZE,
																114, GroupLayout.PREFERRED_SIZE)))
								.addComponent(lb_gia_sp).addComponent(label_thanh_tien, GroupLayout.PREFERRED_SIZE, 54,
										GroupLayout.PREFERRED_SIZE))
						.addContainerGap()));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup().addGap(59)
						.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(lb_title_tensp)
						...
						.addGap(47)
						.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(lb_title_thanh_tien)
								.addComponent(label_thanh_tien))
						.addGap(38).addComponent(btn_mua_sp).addContainerGap(94, Short.MAX_VALUE)));
