...
public class Item extends JFrame {
	...
	public JPanel getItems(String name,String price, String linkImg) {
		...
		JLabel lbPriceItem = new JLabel(price);
		GroupLayout gl_panel = new GroupLayout(panelItem);
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addComponent(btnLinkImg, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 240, 240)
		...
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					.addComponent(btnLinkImg, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
